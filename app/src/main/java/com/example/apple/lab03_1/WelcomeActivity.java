    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FragmentPagerAdapter adapter = new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                Fragmentelcome fragment = null;
                switch (position){
                    case 0:
                        fragment = Fragmentelcome.newInstance(R.layout.fragment_one);
                        break;
                    case 1:
                        fragment = Fragmentelcome.newInstance(R.layout.fragment_two);
                        break;
                    case 2:
                        fragment = Fragmentelcome.newInstance(R.layout.fragment_three);
                        break;
                }
                return fragment;
            }
